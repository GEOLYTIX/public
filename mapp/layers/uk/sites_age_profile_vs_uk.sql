 select 
 	round(dat.age0to18 / (uk.age_under_18_uk / cast(uk.age_total_uk as numeric))  *100,0) as age_under_18,
	round(dat.age18to24 / (uk.age_18to24_uk / cast(uk.age_total_uk as numeric))  *100,0) as age_18_24,
	round(dat.age25to29 / (uk.age_25to29_uk / cast(uk.age_total_uk as numeric))  *100,0) as age_25_29,
	round(dat.age30to44 / (uk.age_30to44_uk / cast(uk.age_total_uk as numeric))  *100,0) as age_30_44,
	round(dat.age45to59 / (uk.age_45to59_uk / cast(uk.age_total_uk as numeric))  *100,0) as age_45_59,
	round(dat.age60plus / (uk.age_60plus_uk / cast(uk.age_total_uk as numeric))  *100,0) as age_over_60
from 
 (select  
