...
uk AS (
SELECT social_grade_ab_uk/(social_grade_total_uk)::numeric as sg_ab_uk_p,
...
SELECT UNNEST( ARRAY ['AB','C1','C2','DE','Total'] ) AS rows,
       UNNEST( ARRAY [min5.sg_ab
					  ,min5.sg_c1
					  ,min5.sg_c2
					  ,min5.sg_de
					  ,min5.sg_total]) AS min5,
       UNNEST( ARRAY [min10.sg_ab
					  ,min10.sg_c1
					  ,min10.sg_c2
					  ,min10.sg_de
					  ,min10.sg_total] ) AS min10,
       UNNEST( ARRAY [min15.sg_ab
					  ,min15.sg_c1
					  ,min15.sg_c2
					  ,min15.sg_de
					  ,min15.sg_total] ) AS min15,
       UNNEST( ARRAY [
       ...
       UNNEST( ARRAY [round(uk.sg_ab_uk_p *100)
